...
def load_kg(model_args):
    ...
    #with open(directory + "entity_neighbor_1_hop.pkl", "wb") as f:
    #    pickle.dump(entity_neighbor_1_hop, f)
    
    """
    with open(directory + "entity2item.pkl", "wb") as f:
        pickle.dump(entity2item, f)
    with open(directory + "item2entity.pkl", "wb") as f:
        pickle.dump(item2entity, f)
